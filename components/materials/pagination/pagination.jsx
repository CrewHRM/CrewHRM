...
export function Pagination({ itemsPerPage=3, pageCount=23 }) {
	...
	return (
		<ReactPaginate
			previousLabel={<i className={'ch-icon ch-icon-arrow-left-2 font-size-24'.classNames()}></i>}
			nextLabel={<i className={'ch-icon ch-icon-arrow-right-2 font-size-24'.classNames()}></i>}
