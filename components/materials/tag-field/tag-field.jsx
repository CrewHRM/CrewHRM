...
export function TagField({theme, value, options, onChange=()=>{}, className='', behavior, fullWidth}) {
	...
	return <div className={`tag theme-${theme} ${fullWidth ? 'full-width' : ''}`.classNames(style) + className}>
		{options.map(option => {
