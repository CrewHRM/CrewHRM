...
export function NoJob() {
	return <div className={'background-color-white text-align-center padding-30 border-radius-5'.classNames()}>
		<img src={img}/>
		<div className={'text-color-secondary margin-top-10 margin-bottom-10 font-size-20 font-weight-600'.classNames()}>
			{__( 'Well done' )}
		</div>
		<div>
			...
			<a href="#" className={'text-color-secondary font-size-16 font-weight-400'.classNames()}>
				{__( 'Add Now' )}
			</a> 
		</div>
	</div>
