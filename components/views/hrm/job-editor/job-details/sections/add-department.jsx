...
export function AddDepartmentModal({addDepartMent}) {
	...
	return <Modal>
		<span className={'d-block font-size-24 font-weight-600 color-primary margin-bottom-20'.classNames()}>
			{__( 'Add Department' )}
		</span>
		...
		<div className={'d-flex align-items-center justify-content-end column-gap-21'.classNames()}>
			<span className={'font-size-15 font-weight-500 letter-spacing--3 color-text-light cursor-pointer'.classNames()} onClick={()=>addDepartMent(null)}>
				{__( 'Cancel' )}
			</span>
