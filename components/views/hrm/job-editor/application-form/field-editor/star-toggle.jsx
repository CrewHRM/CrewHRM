...
const StarToggle = ({ id, initialState = false, onToggle }) => {
  ...
  const colorEmpty = "#72777B";
  const colorFilled = "#FFBA24";
    ...
    >
      ...
      >
        <path
          ...
          fill={isFilled ? colorFilled : 'none'}
          stroke={isFilled ? colorFilled : colorEmpty}
          strokeWidth="1.5"
          strokeLinecap="round"
