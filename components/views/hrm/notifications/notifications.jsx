...
export function NotificationsEmail() {
    ...
    return (
        <DropDownUnmanaged rendered={renderModal()}>
            <div className={'d-flex align-items-center cursor-pointer'.classNames()}>
                {(unopened_count && <IconEmailHasUpdate />) || <IconEmail />}
                <span
                    className={'d-inline-block margin-left-5 font-size-14 font-weight-500 letter-spacing--3 color-text-light'.classNames()}
                >
